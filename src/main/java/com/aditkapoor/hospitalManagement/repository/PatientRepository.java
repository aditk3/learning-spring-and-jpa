...
import com.aditkapoor.hospitalManagement.dto.BloodGroupCountResponseDto;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.aditkapoor.hospitalManagement.dto." +
            "BloodGroupCountResponseDto(p.bloodGroup, Count(p)) from Patient p group by p.bloodGroup")
